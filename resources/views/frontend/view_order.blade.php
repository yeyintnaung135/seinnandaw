                    ...
                    <div class="row pf-container">
                        ...
                        <div class="col-12 col-md-8 view-order-container">
                            @if(!empty($order->product->name))
                                <p>Order #<span style="color: #000;">{{ $order->id }}</span> was placed on <span
                                        style="color: #000;">{{ \Carbon\Carbon::parse($order->created_at)->toFormattedDateString() }}</span>
                                    and is <span style="color: #000;">{{ $order->status }}</span>.</p>
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tr>
                                        <td class="px-3 border"><a
                                                href="{{url('/product/detail/'.$order->product_id)}}">{{ $order->product->name }}</a>
                                            x {{ $order->counts }}</td>
                                ...
                                <table class="table table-bordered mb-0 mt-4">
                                    <tbody>
                                    <tr>
                                        <td class="px-3 bg-white" colspan="2"><h2 class="text-uppercase my-2 text-left"
                                                                                  style="color: #000;">BILLING
                                                ADDRESS</h2></td>
                                    </tr>
                                    <tr>
                                        <td class="px-3">
                                            <ul class="list-unstyled d-flex flex-column">
                                                ...
                                                {{-- <li class="my-1">{{ $order->address }}</li> --}}
                                                <li class="my-1"><i class="fa fa-phone mr-2"></i>{{ $order->phone }}
                                                </li>
                                                <li class="my-1"><i class="fa fa-envelope mr-2"></i>{{ $order->email }}
                                                </li>
                                            </ul>
                                        </td>
                                    </tr>
