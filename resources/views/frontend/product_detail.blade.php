            ...
            <div>
              ...
              >
                <div class="swiper-wrapper">
                  <div class="swiper-slide" data-src="{{ url($data->photo) }}" data-fancybox="product_detail">
...
{{--              </div>--}}
          ...
          <div class="col-12 col-md-6">
            <div>
              ...
              <p class="border-top mt-4 pt-2">Category: <a href="#" class="sn-pd-cat" style="font-size: 16px;">{{$cat->name}}</a></p>
            </div>
          </div>
        </div>
        <div>
