    ...
    <section>
        <div class="container-fluid px-3 py-4 px-md-4 py-md-5">            
            <div class="card text-center payment-success-container">
              <div class="mt-4"><img src="{{url('images/logo.png')}}" alt="SeinNanDaw" class="card-img-top" style="width: 160px;"></div>
              ...
              <ul class="list-group border-0" style="color: #505050;">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center border-0 p-0 pt-2 my-2 mx-5" style="color: #000;">
                  <h4>Paid Amount</h4>
